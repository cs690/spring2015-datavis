...
function drawGPLOM(data)
{
	...
	var barchart1 = barchart().width(200).height(200)
			...
			.maxValue(maxValue).margin({ top: 40, right: 10, bottom: 30, left: 20 }).offAxis(true),
	...
	var drawXAxis = new Axis().canvasID("#cell13").isCategorical(true)
		.isHorizontal(false).isColor(true).categoryName("category")
