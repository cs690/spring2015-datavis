...
function drawGPLOM(data)
{
	...
	heatmap1.Margin(30, 20, 30, 60).ScreenWidth(250).ScreenHeight(250).Canvas("#cell1");
	heatmap2.Margin(30, 20, 30, 60).ScreenWidth(250).ScreenHeight(250).Canvas("#cell2");
	heatmap3.Margin(30, 20, 30, 60).ScreenWidth(250).ScreenHeight(250).Canvas("#cell3");

	var scatterplot1 = new ScatterPlot(),
		scatterplot2 = new ScatterPlot(),
		scatterplot3 = new ScatterPlot();

	scatterplot1.Margin(30, 20, 30, 40).ScreenWidth(250).ScreenHeight(250).Canvas("#cell6").ShowTicks(false);
	scatterplot2.Margin(30, 20, 30, 40).ScreenWidth(250).ScreenHeight(250).Canvas("#cell9").ShowTicks(false);
	scatterplot3.Margin(30, 20, 30, 40).ScreenWidth(250).ScreenHeight(250).Canvas("#cell10").ShowTicks(false);
