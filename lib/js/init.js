...
function drawGPLOM(data)
{
	...
	console.log(dataHandler.findMaxValue(["ratings", "comments", "length"]));
	...
	heatmap1.Margin(20, 20, 20, 30).ScreenWidth(200).ScreenHeight(200).Canvas("#cell1");
	heatmap2.Margin(20, 20, 20, 30).ScreenWidth(200).ScreenHeight(200).Canvas("#cell2");
	heatmap3.Margin(20, 20, 20, 30).ScreenWidth(200).ScreenHeight(200).Canvas("#cell3");
	...
	scatterplot1.Margin(30, 20, 30, 40).ScreenWidth(200).ScreenHeight(200).Canvas("#cell6").ShowTicks(false);
	scatterplot2.Margin(30, 20, 30, 40).ScreenWidth(200).ScreenHeight(200).Canvas("#cell9").ShowTicks(false);
	scatterplot3.Margin(30, 20, 30, 40).ScreenWidth(200).ScreenHeight(200).Canvas("#cell10").ShowTicks(false);
	...
	scatterplot1.bindData(data, "ratings", "comments", "video_ID", ["views", "rate", "category"]).draw();//.updateAxis("ratings", ratingsMax).updateAxis("comments", viewsMax);
	scatterplot2.bindData(data, "length", "comments", "video_ID", ["views", "rate", "category"]).draw();//.updateAxis("comments", ratingsMax);
	scatterplot3.bindData(data, "length", "ratings", "video_ID", ["views", "rate", "category"]).draw();//.updateAxis("ratings", ratingsMax);
