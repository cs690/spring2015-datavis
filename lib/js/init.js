...
scattorplot.Margin(20, 20, 30, 40).ScreenWidth(500).ScreenHeight(300).Canvas("#xihan1");

var heatmap = new Heatmap();
heatmap.Margin(20, 20, 30, 40).ScreenWidth(800).ScreenHeight(300).Canvas("#xihan2");

var drawGPLOM = function (data){
	var heatmap = new Heatmap(),
	...
	var barchart1 = barchart().width(350).height(350)
		...
		barchart2 = barchart().width(350).height(350)
			...
			.yLabel("Ratings (average)").tooltipLabel("Ratings").svgID("barsvg2").canvasID("cell3").labelFontSize(9),
