...
function drawGPLOM(data)
{
	...
	heatmap1.Margin(30, 20, 20, 30).ScreenWidth(200).ScreenHeight(200).Canvas("#cell1");
	heatmap2.Margin(30, 20, 20, 30).ScreenWidth(200).ScreenHeight(200).Canvas("#cell2");
    heatmap3.Margin(30, 20, 20, 30).ScreenWidth(200).ScreenHeight(200).Canvas("#cell3");
	//heatmap1.Margin(5, 5, 5, 5).ScreenWidth(200).ScreenHeight(200).Canvas("#cell1").DisplayAxisX(false).DisplayAxisY(false);
	//heatmap2.Margin(5, 5, 5, 5).ScreenWidth(200).ScreenHeight(200).Canvas("#cell2").DisplayAxisX(false).DisplayAxisY(false);
	//heatmap3.Margin(5, 5, 5, 5).ScreenWidth(200).ScreenHeight(200).Canvas("#cell3").DisplayAxisX(false).DisplayAxisY(false);

	var scatterplot1 = new ScatterPlot(),
		scatterplot2 = new ScatterPlot(),
		scatterplot3 = new ScatterPlot();

	scatterplot1.Margin(40, 20, 30, 40).ScreenWidth(200).ScreenHeight(200).Canvas("#cell6").ShowTicks(false);
	scatterplot2.Margin(40, 20, 30, 40).ScreenWidth(200).ScreenHeight(200).Canvas("#cell9").ShowTicks(false);
	scatterplot3.Margin(40, 20, 30, 40).ScreenWidth(200).ScreenHeight(200).Canvas("#cell10").ShowTicks(false);
