...
function drawGPLOM(data)
{
	...
	var drawYAxisCol3 = new Axis().canvasID("#col3label").maxValue(maxValue).isHorizontal(true).height(30).margin({ top: 0, right: 10, bottom: 0, left: 10 }).ticks(6);
	drawYAxisCol3();
	var drawYAxisCol4 = new Axis().canvasID("#col4label").maxValue(maxValue).isHorizontal(true).height(30).margin({ top: 0, right: 10, bottom: 0, left: 10 }).ticks(6);
	drawYAxisCol4();
	...
	controller.registerChart(drawXAxisRow1);
	controller.registerChart(drawXAxisRow2);
}
