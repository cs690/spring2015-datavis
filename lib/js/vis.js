...
function Heatmap(top, right, bottom, left, screenWidth, screenHeight)
{
    ...
    if (typeof this._initialized == "undefined")
    {
        ...
        this.bindData = function (data, attrX, attrY, attrV)
        {
            ...
            this._axisX.name = attrX;
            this._axisX.value = function (d) { return d[attrX]; };
            this._axisX.categories = ["A", "< 10000", "B", "< 50000", "C", "< 100000", "D", ">= 100000", "E"];
            ...
            this._axisY.name = attrY;
            this._axisY.value = function (d) { return d[attrY]; };
            this._axisY.categories = ["A", "0-1", "B", "1-2", "C", "2-3", "D", "3-4", "E", "4-5", "F"];
        ...
        this.draw = function ()
        {
			...
			.enter().append("rect")
			  ...
			  .attr("x", function (d) { return that._axisX.scale(that._categoryMap['attrX'][d['attrX']]) - that._axisX.scale.range()[1] + 2; })
			  .attr("y", function (d) { return that._axisY.scale(that._categoryMap['attrY'][d['attrY']]) - that._axisY.scale.range()[that._axisY.categories.length - 2] + 2; })
              .attr("width", this._axisX.scale.range()[1]*2 - 4)
              .attr("height", this._axisY.scale.range()[this._axisY.categories.length - 2]*2 - 4)
