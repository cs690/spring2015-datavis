function barchart() {
    ...
    function chart(selection) {
        ...
        selection.each(function (data){
            ...
            data.forEach(function(d,i){
                //Count frequencies (here, assume that categorical values are integers such that 1 ... n)
            ...
            svg.selectAll("rect").data(processedData).enter().append("rect").
                ...
                .attr("class", function(d, i) {
                        console.log("Attached a class name to a bar: bar" + d.categIndex);
                		return "bar bar" + d.categIndex;
                	})
                .on("mouseover", tip.show)
                .on("mouseenter", function(d, i){
                    console.log("Mouseenter event, and the index is " + d.categIndex);
                    commonOnEvent(d.categIndex);
                })
                .on("mouseout", function(d, i){
                    tip.hide();
                    commonLeaveEvent(d.categIndex);
                })
                .transition()
                .duration(800)
