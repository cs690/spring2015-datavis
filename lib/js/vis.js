...
function Heatmap(top, right, bottom, left, screenWidth, screenHeight)
{
    ...
    if (typeof this._initialized == "undefined") {
        ...
        this.draw = function ()
        {
            ...
            this._selectionX = svg.append("rect").attr("class", "selection x_" + this._axisX.data.name).style("opacity", 0);
            this._selectionY = svg.append("rect").attr("class", "selection y_" + this._axisY.data.name).style("opacity", 0);
