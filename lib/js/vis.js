                ...
                tip = d3.tip()
                    ...
                    .html(function (d)
                    {
                        return "<strong>" + tooltipYLabel + ": </strong> " +
                            ...
                            "<span style='color:#4e240e'>" + d.category + "</span>";
                    })
...
function ScatterPlot(top, right, bottom, left, screenWidth, screenHeight)
{
    ...
    if (typeof this._initialized == "undefined") {
        ...
        this.ShowTicks = function (value)
        {
            if (!arguments.length) return this._showTicks;
...
function Heatmap(top, right, bottom, left, screenWidth, screenHeight)
{
    ...
    if (typeof this._initialized == "undefined") {
        ...
        this.DisplayAxisX = function (value)
        {
            if (!arguments.length) return this._axisX.visible;
            this._axisX.visible = value;
            return this;
        }

        this.DisplayAxisY = function (value)
        {
            if (!arguments.length) return this._axisY.visible;
            this._axisY.visible = value;
            return this;
        }
...
function colorLegends(){
    ...
    draw.canvasID = function (value) {
        if (!arguments.length) return canvasID;
        canvasID = value;
        return draw;
    }

    draw.colorMap = function (value) {
        if (!arguments.length) return colorMap;
        colorMap = d3.entries(value);
        return draw;
    }
