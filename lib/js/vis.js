...
function Heatmap(top, right, bottom, left, screenWidth, screenHeight)
{
    ...
    if (typeof this._initialized == "undefined") {
        ...
        this.bindData = function (data, attrX, catX, attrY, catY, attrV)
        {
            ...
            colorValues.unshift('#ffffff');
            this._id.color = d3.scale.threshold().domain(DataHandler.prototype.getColorDomain()).range(colorValues);
            /*
            <50         #c7e9b4
            50-150      #7fcdbb
            150-250     #41b6c4
...
function DataHandler(data)
{
    ...
    if (typeof this._initialized == "undefined") {
        ...
        {
            return [0, 50, 150, 250, 400, 700, 1847].slice();
        }
