    ...
    if (typeof this._initialized == "undefined")
    {
        ...
        this.draw = function ()
        {
			...
			.enter().append("rect")
			  ...
			  .attr("x", function (d) { return that._axisX.scale(that._axisX.categories_origin[+d['attrX'] - 1]) - that._axisX.scale.range()[1] + 1.5; })
			  .attr("y", function (d) { return that._axisY.scale(that._axisY.categories_origin[+d['attrY'] - 1]) - that._axisY.scale.range()[that._axisY.categories_extend.length - 2] + 1.5; })
              .attr("width", this._axisX.scale.range()[1] * 2 - 3)
              .attr("height", this._axisY.scale.range()[this._axisY.categories_extend.length - 2] * 2 - 3)
