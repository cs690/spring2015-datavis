...
function Heatmap(top, right, bottom, left, screenWidth, screenHeight)
{
    ...
    if (typeof this._initialized == "undefined") {
        ...
        this.bindData = function (data, attrX, catX, attrY, catY, attrV)
        {
            ...
            this._id.color = d3.scale.threshold().domain(DataHandler.prototype.getColorDomain()).range(DataHandler.prototype.getColorValues());
            /*
            <50         #c7e9b4
            50-150      #7fcdbb
            150-250     #41b6c4
...
function commonOnEvent(classes, isScatter, isBar, isHeatmap)
{
    ...
    if (isHeatmap) {
        ...
        classes.forEach(function (d)
        {
            ...
            d3.selectAll('.l_' + d).style("stroke-width", "1px").style("fill", "red").style("stroke", "red");
        });
    }
    else if (isBar) {
        d3.selectAll(".scatter").style("opacity", "0.05");
        ...
        d3.selectAll('.l_' + classes[0]).style("stroke-width", "1px").style("fill", "red").style("stroke", "red");
...
function DataHandler(data)
{
    ...
    if (typeof this._initialized == "undefined") {
        ...
        {
            return [0, 50, 150, 250, 400, 700, 1847];
        }

        DataHandler.prototype.getColorValues = function ()
        {
            return ['#ffffff', '#c7e9b4', '#7fcdbb', '#41b6c4', '#1d91c0', '#225ea8', '#0c2c84', '#ffffff'];
        }
